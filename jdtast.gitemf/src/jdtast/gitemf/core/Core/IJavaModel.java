 ...
 * </p>
 * <ul>
 *   <li>{@link jdtast.gitemf.core.Core.IJavaModel#getJavaProjects <em>Java Projects</em>}</li>
 *   <li>{@link jdtast.gitemf.core.Core.IJavaModel#getExternalPackageFragmentRoots <em>External Package Fragment Roots</em>}</li>
 * </ul>
 *
 * @see jdtast.gitemf.core.Core.CorePackage#getIJavaModel()
 * @model
 * @generated
 */
public interface IJavaModel extends PhysicalElement {
	 ...
	 * @see jdtast.gitemf.core.Core.CorePackage#getIJavaModel_JavaProjects()
	 ...
	 * @see jdtast.gitemf.core.Core.CorePackage#getIJavaModel_ExternalPackageFragmentRoots()
	 * @model containment="true"
	 * @generated
	 */
