 ...
 * </p>
 * <ul>
 *   <li>{@link jdtast.gitemf.dom.DOM.Comment#getAlternateRoot <em>Alternate Root</em>}</li>
 * </ul>
 *
 * @see jdtast.gitemf.dom.DOM.DOMPackage#getComment()
 * @model abstract="true"
 * @generated
 */
public interface Comment extends ASTNode {
	 ...
	 * @see jdtast.gitemf.dom.DOM.DOMPackage#getComment_AlternateRoot()
	...
	/**
	 * Sets the value of the '{@link jdtast.gitemf.dom.DOM.Comment#getAlternateRoot <em>Alternate Root</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
