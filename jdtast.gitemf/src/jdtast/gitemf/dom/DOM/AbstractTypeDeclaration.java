 ...
 * </p>
 * <ul>
 *   <li>{@link jdtast.gitemf.dom.DOM.AbstractTypeDeclaration#getBodyDeclarations <em>Body Declarations</em>}</li>
 *   <li>{@link jdtast.gitemf.dom.DOM.AbstractTypeDeclaration#getName <em>Name</em>}</li>
 *   <li>{@link jdtast.gitemf.dom.DOM.AbstractTypeDeclaration#getLocalTypeDeclaration <em>Local Type Declaration</em>}</li>
 *   <li>{@link jdtast.gitemf.dom.DOM.AbstractTypeDeclaration#getMemberTypeDeclaration <em>Member Type Declaration</em>}</li>
 *   <li>{@link jdtast.gitemf.dom.DOM.AbstractTypeDeclaration#getPackageMemberTypeDeclaration <em>Package Member Type Declaration</em>}</li>
 * </ul>
 *
 * @see jdtast.gitemf.dom.DOM.DOMPackage#getAbstractTypeDeclaration()
 * @model abstract="true"
 * @generated
 */
public interface AbstractTypeDeclaration extends BodyDeclaration {
	 ...
	 * The list contents are of type {@link jdtast.gitemf.dom.DOM.BodyDeclaration}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see jdtast.gitemf.dom.DOM.DOMPackage#getAbstractTypeDeclaration_BodyDeclarations()
	 ...
	 * @see jdtast.gitemf.dom.DOM.DOMPackage#getAbstractTypeDeclaration_Name()
	...
	/**
	 * Sets the value of the '{@link jdtast.gitemf.dom.DOM.AbstractTypeDeclaration#getName <em>Name</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see jdtast.gitemf.dom.DOM.DOMPackage#getAbstractTypeDeclaration_LocalTypeDeclaration()
	...
	/**
	 * Sets the value of the '{@link jdtast.gitemf.dom.DOM.AbstractTypeDeclaration#getLocalTypeDeclaration <em>Local Type Declaration</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see jdtast.gitemf.dom.DOM.DOMPackage#getAbstractTypeDeclaration_MemberTypeDeclaration()
	 * @model unique="false" dataType="jdtast.gitemf.ptypes.PrimitiveTypes.Boolean" required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link jdtast.gitemf.dom.DOM.AbstractTypeDeclaration#getMemberTypeDeclaration <em>Member Type Declaration</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see jdtast.gitemf.dom.DOM.DOMPackage#getAbstractTypeDeclaration_PackageMemberTypeDeclaration()
	 * @model unique="false" dataType="jdtast.gitemf.ptypes.PrimitiveTypes.Boolean" required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link jdtast.gitemf.dom.DOM.AbstractTypeDeclaration#getPackageMemberTypeDeclaration <em>Package Member Type Declaration</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
