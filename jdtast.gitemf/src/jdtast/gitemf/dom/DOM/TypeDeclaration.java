 ...
 * </p>
 * <ul>
 *   <li>{@link jdtast.gitemf.dom.DOM.TypeDeclaration#getSuperclassType <em>Superclass Type</em>}</li>
 *   <li>{@link jdtast.gitemf.dom.DOM.TypeDeclaration#getInterface <em>Interface</em>}</li>
 *   <li>{@link jdtast.gitemf.dom.DOM.TypeDeclaration#getSuperInterfaceTypes <em>Super Interface Types</em>}</li>
 *   <li>{@link jdtast.gitemf.dom.DOM.TypeDeclaration#getTypeParameters <em>Type Parameters</em>}</li>
 * </ul>
 *
 * @see jdtast.gitemf.dom.DOM.DOMPackage#getTypeDeclaration()
 * @model
 * @generated
 */
public interface TypeDeclaration extends AbstractTypeDeclaration {
	 ...
	 * @see jdtast.gitemf.dom.DOM.DOMPackage#getTypeDeclaration_SuperclassType()
	...
	/**
	 * Sets the value of the '{@link jdtast.gitemf.dom.DOM.TypeDeclaration#getSuperclassType <em>Superclass Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see jdtast.gitemf.dom.DOM.DOMPackage#getTypeDeclaration_Interface()
	...
	/**
	 * Sets the value of the '{@link jdtast.gitemf.dom.DOM.TypeDeclaration#getInterface <em>Interface</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see jdtast.gitemf.dom.DOM.DOMPackage#getTypeDeclaration_SuperInterfaceTypes()
	 ...
	 * @see jdtast.gitemf.dom.DOM.DOMPackage#getTypeDeclaration_TypeParameters()
	 * @model containment="true"
	 * @generated
	 */
