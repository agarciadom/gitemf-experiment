 ...
 * </p>
 * <ul>
 *   <li>{@link jdtast.gitemf.dom.DOM.StringLiteral#getEscapedValue <em>Escaped Value</em>}</li>
 *   <li>{@link jdtast.gitemf.dom.DOM.StringLiteral#getLiteralValue <em>Literal Value</em>}</li>
 * </ul>
 *
 * @see jdtast.gitemf.dom.DOM.DOMPackage#getStringLiteral()
 * @model
 * @generated
 */
public interface StringLiteral extends Expression {
	 ...
	 * @see jdtast.gitemf.dom.DOM.DOMPackage#getStringLiteral_EscapedValue()
	...
	/**
	 * Sets the value of the '{@link jdtast.gitemf.dom.DOM.StringLiteral#getEscapedValue <em>Escaped Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see jdtast.gitemf.dom.DOM.DOMPackage#getStringLiteral_LiteralValue()
	 * @model unique="false" dataType="jdtast.gitemf.ptypes.PrimitiveTypes.String" required="true" ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link jdtast.gitemf.dom.DOM.StringLiteral#getLiteralValue <em>Literal Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
