 ...
 * </p>
 * <ul>
 *   <li>{@link jdtast.gitemf.dom.DOM.impl.AnnotationImpl#getTypeName <em>Type Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AnnotationImpl extends ExpressionImpl implements Annotation {
	...
	public Name getTypeName() {
		return (Name)eDynamicGet(DOMPackage.ANNOTATION__TYPE_NAME, DOMPackage.Literals.ANNOTATION__TYPE_NAME, true, true);
	}
	...
	public NotificationChain basicSetTypeName(Name newTypeName, NotificationChain msgs) {
		msgs = eDynamicInverseAdd((InternalEObject)newTypeName, DOMPackage.ANNOTATION__TYPE_NAME, msgs);
		return msgs;
	}
	...
	public void setTypeName(Name newTypeName) {
		eDynamicSet(DOMPackage.ANNOTATION__TYPE_NAME, DOMPackage.Literals.ANNOTATION__TYPE_NAME, newTypeName);
	}
