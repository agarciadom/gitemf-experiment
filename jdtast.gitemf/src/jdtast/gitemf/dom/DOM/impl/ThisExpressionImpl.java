 ...
 * </p>
 * <ul>
 *   <li>{@link jdtast.gitemf.dom.DOM.impl.ThisExpressionImpl#getQualifier <em>Qualifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ThisExpressionImpl extends ExpressionImpl implements ThisExpression {
	...
	public Name getQualifier() {
		return (Name)eDynamicGet(DOMPackage.THIS_EXPRESSION__QUALIFIER, DOMPackage.Literals.THIS_EXPRESSION__QUALIFIER, true, true);
	}
	...
	public NotificationChain basicSetQualifier(Name newQualifier, NotificationChain msgs) {
		msgs = eDynamicInverseAdd((InternalEObject)newQualifier, DOMPackage.THIS_EXPRESSION__QUALIFIER, msgs);
		return msgs;
	}
	...
	public void setQualifier(Name newQualifier) {
		eDynamicSet(DOMPackage.THIS_EXPRESSION__QUALIFIER, DOMPackage.Literals.THIS_EXPRESSION__QUALIFIER, newQualifier);
	}
